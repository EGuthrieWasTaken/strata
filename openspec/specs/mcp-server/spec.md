...
Rationale: `docs/spec/15-roadmap.md` M2.1 (Local MCP server).
...
_Source: `docs/spec/15-roadmap.md` M2.1_
...
_Source: `docs/spec/15-roadmap.md` M2.1; `docs/spec/12-architecture.md` §2_
